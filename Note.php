...
$sql = "SELECT a.date, a.monthly, a.status, a.time_in, a.time_out, e.firstname, e.lastname 
        FROM attendance a 
...
<img src="assets\img\profiles/Aarka.png" alt="" height="50">
</span>
...
<div class="container">
    ...
    <div class="note-form">
        <form id="noteForm">
            ...
            <textarea id="noteContent" rows="4" placeholder="Content" required></textarea>
