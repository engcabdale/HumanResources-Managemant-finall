...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO attendance (date, monthly, status, time_in, time_out, employee_id)
            VALUES (?, ?, ?, ?, ?, ?)";
    
    // Prepare the statement
    $stmt = $conn->prepare($sql);
    $stmt->bind_param("sssssi", $date, $monthly, $status, $time_in, $time_out, $employee_id);
...
<form action="add_Attendance.php" enctype="multipart/form-data" method="post">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-xl-6 col-sm-12 col-12">
                                    <div class="form-group">
                                        <label>Monthly:</label>
                                        <input type="text" name="monthly" id="monthly" placeholder="Monthly">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-xl-6 col-sm-12 col-12">
                                    <div class="form-group">
                                        <label>Time In:</label>
                                        <input type="datetime-local" name="time_in" id="time_in" placeholder="Time In">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-xl-6 col-sm-12 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="datetime-local" name="time_out" id="time_out" placeholder="Time Out">
                                    </div>
                                </div>
                                <div class="col-xl-6 col-sm-12 col-12">
                                    <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-xl-12 col-sm-12 col-12">
                                    <div class="form-btn">
                                        <button class="btn btn-apply w-auto" type="submit">Add Attendance</button>
