...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $schedule_name = $_POST['schedule_name']; // Retrieve the new input

    // Prepare and bind
    $stmt = $conn->prepare("INSERT INTO schedule (time_in, time_out, emp_id, schedule_name) VALUES (?, ?, ?, ?)");
    $stmt->bind_param("ssis", $time_in, $time_out, $employee_id, $schedule_name);
...
<form action="add_schedule.php" enctype="multipart/form-data" method="post">
    ...
    <div class="form-group">
        ...
        <input type="text" name="schedule_name" id="schedule_name" placeholder="Schedule Name">
                            ...
                            <div class="row">
                                <div class="col-xl-12 col-sm-12 col-12 ">
                                    <div class="form-btn">
                                        <button class="btn btn-apply w-auto" type="submit">Add schedule</button>
