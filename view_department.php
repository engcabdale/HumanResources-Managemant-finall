            ...
            <div class="col-xl-12 col-sm-12 col-12">
                <div class="card card-lists">
                    <div class="card-header">
                        <h2 class="card-titles">Department List</h2>
                        <a href="department.php" class="btn btn-head"> Add Department </a>
                    </div>
                    <div class="card-body p-0">
                        <div class="table-responsive">
                            <table class="table custom-table no-footer">
                                ...
                                <tbody>
                                    <?php
                                    // Fetch departments and related employee names
                                    $sql = "SELECT d.department_name, e.firstname, e.lastname 
                                            FROM department d
