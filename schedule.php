...
// Fetch schedule data
$query = "SELECT * FROM schedule"; // Modify with your actual table name and columns
...
<h2 class="card-titles">schedule</h2>
<a href="add_schedule.php" class="btn btn-head"> Add schedule </a>
</div>
        ...
        <table class="table custom-table no-footer">
            ...
            <tbody>
                <?php while ($row = $result->fetch_assoc()) : ?>
                    <tr>
                                                <td><?php echo htmlspecialchars($row['schedule_name']); ?></td>
